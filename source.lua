...
local RayfieldLibrary = {
    ...
    Background = Color3.fromRGB(255,240,248),
    Topbar = Color3.fromRGB(255,210,235),
    Shadow = Color3.fromRGB(255,180,215),

    NotificationBackground = Color3.fromRGB(255,235,245),
    NotificationActionsBackground = Color3.fromRGB(255,220,235),

    TabBackground = Color3.fromRGB(255,215,235),
    TabStroke = Color3.fromRGB(255,170,210),
    TabBackgroundSelected = Color3.fromRGB(255,170,220),
    TabTextColor = Color3.fromRGB(255,255,255),
    SelectedTabTextColor = Color3.fromRGB(255,255,255),

    ElementBackground = Color3.fromRGB(255,225,240),
    ElementBackgroundHover = Color3.fromRGB(255,210,235),
    SecondaryElementBackground = Color3.fromRGB(255,240,248),

    SliderBackground = Color3.fromRGB(255,120,190),
    SliderProgress = Color3.fromRGB(255,80,170),

    ToggleEnabled = Color3.fromRGB(255,90,180),
    ToggleDisabled = Color3.fromRGB(210,180,190),
