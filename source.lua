...
local RayfieldLibrary = {
	...
	Theme = {
		...
		Girl = {
    TextColor = Color3.fromRGB(90, 30, 70),

    Background = Color3.fromRGB(255, 235, 245),
    Topbar = Color3.fromRGB(255, 195, 225),
    Shadow = Color3.fromRGB(220, 150, 190),

    NotificationBackground = Color3.fromRGB(255, 225, 240),
    NotificationActionsBackground = Color3.fromRGB(255, 205, 230),

    TabBackground = Color3.fromRGB(255, 215, 235),
    TabStroke = Color3.fromRGB(255, 150, 205),
    TabBackgroundSelected = Color3.fromRGB(255, 90, 180),
    TabTextColor = Color3.fromRGB(90, 30, 70),
    SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

    ElementBackground = Color3.fromRGB(255, 225, 240),
    ElementBackgroundHover = Color3.fromRGB(255, 210, 235),
    SecondaryElementBackground = Color3.fromRGB(255, 235, 245),
    ElementStroke = Color3.fromRGB(255, 170, 215),
    SecondaryElementStroke = Color3.fromRGB(255, 185, 220),

    SliderBackground = Color3.fromRGB(255, 140, 205),
    SliderProgress = Color3.fromRGB(255, 70, 170),
    SliderStroke = Color3.fromRGB(255, 170, 220),

    ToggleBackground = Color3.fromRGB(255, 215, 235),
    ToggleEnabled = Color3.fromRGB(255, 70, 170),
    ToggleDisabled = Color3.fromRGB(210, 180, 195),
    ToggleEnabledStroke = Color3.fromRGB(255, 140, 210),
    ToggleDisabledStroke = Color3.fromRGB(215, 190, 205),
    ToggleEnabledOuterStroke = Color3.fromRGB(255, 40, 150),
    ToggleDisabledOuterStroke = Color3.fromRGB(180, 165, 180),

    DropdownSelected = Color3.fromRGB(255, 220, 240),
    DropdownUnselected = Color3.fromRGB(255, 235, 245),

    InputBackground = Color3.fromRGB(255, 235, 245),
    InputStroke = Color3.fromRGB(255, 170, 215),
    PlaceholderColor = Color3.fromRGB(180, 110, 150)
},
	...
	Topbar = Color3.fromRGB(20,23,29),
	Shadow = Color3.fromRGB(8,10,14),

	NotificationBackground = Color3.fromRGB(18,20,25),
	NotificationActionsBackground = Color3.fromRGB(32,36,44),

	TabBackground = Color3.fromRGB(25,30,38),
	TabStroke = Color3.fromRGB(40,48,60),
	TabBackgroundSelected = Color3.fromRGB(0,170,255),
	TabTextColor = Color3.fromRGB(200,205,215),
	SelectedTabTextColor = Color3.fromRGB(255,255,255),

	ElementBackground = Color3.fromRGB(20,24,30),
	ElementBackgroundHover = Color3.fromRGB(28,32,40),
	SecondaryElementBackground = Color3.fromRGB(18,22,28),
	ElementStroke = Color3.fromRGB(38,45,58),
	SecondaryElementStroke = Color3.fromRGB(34,40,52),

	SliderBackground = Color3.fromRGB(40,50,65),
	SliderProgress = Color3.fromRGB(0,170,255),
	SliderStroke = Color3.fromRGB(80,200,255),

	ToggleBackground = Color3.fromRGB(22,26,32),
	ToggleEnabled = Color3.fromRGB(0,170,255),
	ToggleDisabled = Color3.fromRGB(90,90,90),
	ToggleEnabledStroke = Color3.fromRGB(90,220,255),
	ToggleDisabledStroke = Color3.fromRGB(120,120,120),
	ToggleEnabledOuterStroke = Color3.fromRGB(0,120,200),
	ToggleDisabledOuterStroke = Color3.fromRGB(60,60,60),

	DropdownSelected = Color3.fromRGB(30,34,42),
	...
	PlaceholderColor = Color3.fromRGB(170,170,170)
		...
		Premium = {
	TextColor = Color3.fromRGB(255,248,220),
	...
	NotificationActionsBackground = Color3.fromRGB(40,35,20),

	TabBackground = Color3.fromRGB(24,24,24),
	TabStroke = Color3.fromRGB(70,55,20),
	TabBackgroundSelected = Color3.fromRGB(255,190,40),
	TabTextColor = Color3.fromRGB(230,220,190),
	...
	ElementStroke = Color3.fromRGB(80,60,20),
	SecondaryElementStroke = Color3.fromRGB(60,45,15),

	SliderBackground = Color3.fromRGB(90,70,20),
	SliderProgress = Color3.fromRGB(255,190,40),
	SliderStroke = Color3.fromRGB(255,220,90),

	ToggleBackground = Color3.fromRGB(20,20,20),
	ToggleEnabled = Color3.fromRGB(255,190,40),
	ToggleDisabled = Color3.fromRGB(90,90,90),
	ToggleEnabledStroke = Color3.fromRGB(255,220,90),
	ToggleDisabledStroke = Color3.fromRGB(120,120,120),
	ToggleEnabledOuterStroke = Color3.fromRGB(180,130,20),
	ToggleDisabledOuterStroke = Color3.fromRGB(60,60,60),

	DropdownSelected = Color3.fromRGB(35,30,20),
	DropdownUnselected = Color3.fromRGB(20,20,20),

	InputBackground = Color3.fromRGB(18,18,18),
	InputStroke = Color3.fromRGB(80,60,20),
	PlaceholderColor = Color3.fromRGB(180,160,120)
},
		...
		Nebula = {
			TextColor = Color3.fromRGB(230, 225, 245),

			Background = Color3.fromRGB(18, 16, 28),
			Topbar = Color3.fromRGB(26, 22, 40),
			Shadow = Color3.fromRGB(10, 8, 18),

			NotificationBackground = Color3.fromRGB(22, 19, 34),
			NotificationActionsBackground = Color3.fromRGB(235, 230, 250),

			TabBackground = Color3.fromRGB(35, 30, 55),
			TabStroke = Color3.fromRGB(60, 50, 90),
			TabBackgroundSelected = Color3.fromRGB(150, 90, 230),
			TabTextColor = Color3.fromRGB(210, 200, 235),
			SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

			ElementBackground = Color3.fromRGB(28, 24, 44),
			ElementBackgroundHover = Color3.fromRGB(36, 30, 54),
			SecondaryElementBackground = Color3.fromRGB(24, 20, 38),
			ElementStroke = Color3.fromRGB(55, 45, 80),
			SecondaryElementStroke = Color3.fromRGB(48, 40, 70),

			SliderBackground = Color3.fromRGB(80, 50, 140),
			SliderProgress = Color3.fromRGB(165, 95, 230),
			SliderStroke = Color3.fromRGB(195, 130, 255),

			ToggleBackground = Color3.fromRGB(28, 24, 44),
			ToggleEnabled = Color3.fromRGB(165, 95, 230),
			ToggleDisabled = Color3.fromRGB(80, 75, 95),
			ToggleEnabledStroke = Color3.fromRGB(195, 130, 255),
			ToggleDisabledStroke = Color3.fromRGB(100, 95, 115),
			ToggleEnabledOuterStroke = Color3.fromRGB(120, 70, 180),
			ToggleDisabledOuterStroke = Color3.fromRGB(60, 55, 75),

			DropdownSelected = Color3.fromRGB(36, 30, 54),
			DropdownUnselected = Color3.fromRGB(24, 20, 38),

			InputBackground = Color3.fromRGB(24, 20, 38),
			InputStroke = Color3.fromRGB(55, 45, 80),
			PlaceholderColor = Color3.fromRGB(150, 140, 175)
		},
	}
}
...
local function ChangeTheme(Theme)
	local ThemeName = typeof(Theme) == 'string' and Theme or nil
	...
	-- The "RGB" theme is meant to be the animated rainbow look: switching to
	-- it turns on RGB Sync automatically, and switching away turns it off
	if RayfieldLibrary.SetRGBSync then
		RayfieldLibrary:SetRGBSync(ThemeName == 'RGB')
	end
end

-- ================== RGB Sync ==================
-- Animated colour-cycling effect for the window border, topbar accent and
-- (when shown) the Key System frame. Purely cosmetic — does not alter any
-- functionality. Enable via CreateWindow({ RGBSync = true, RGBSyncSpeed = 1 })
-- or at runtime with RayfieldLibrary:SetRGBSync(true)

local RGBSyncEnabled = false
local RGBSyncSpeed = 1 -- higher = faster colour cycling
local RGBSyncSaturation = 0.85
local RGBSyncConnection = nil
local KeySystemRGBStroke = nil -- set while the Key System UI is visible

-- Outer border on the main window (hidden/transparent until RGB Sync is enabled)
local MainRGBStroke = Main:FindFirstChild("RGBStroke")
if not MainRGBStroke then
	MainRGBStroke = Instance.new("UIStroke")
	MainRGBStroke.Name = "RGBStroke"
	MainRGBStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	MainRGBStroke.Thickness = 1.5
	MainRGBStroke.Transparency = 1
	MainRGBStroke.Parent = Main
end

-- Thin accent line under the topbar
local TopbarRGBAccent = Topbar:FindFirstChild("RGBAccent")
if not TopbarRGBAccent then
	TopbarRGBAccent = Instance.new("Frame")
	TopbarRGBAccent.Name = "RGBAccent"
	TopbarRGBAccent.BorderSizePixel = 0
	TopbarRGBAccent.AnchorPoint = Vector2.new(0, 1)
	TopbarRGBAccent.Position = UDim2.new(0, 0, 1, 0)
	TopbarRGBAccent.Size = UDim2.new(1, 0, 0, 2)
	TopbarRGBAccent.BackgroundColor3 = Color3.new(1, 1, 1)
	TopbarRGBAccent.BackgroundTransparency = 1
	TopbarRGBAccent.ZIndex = 10
	TopbarRGBAccent.Parent = Topbar
end

local function startRGBSync()
	if RGBSyncConnection then return end
	MainRGBStroke.Transparency = 0
	TopbarRGBAccent.BackgroundTransparency = 0
	RGBSyncConnection = RunService.Heartbeat:Connect(function()
		local hue = (tick() * RGBSyncSpeed * 0.15) % 1
		local colour = Color3.fromHSV(hue, RGBSyncSaturation, 1)
		MainRGBStroke.Color = colour
		TopbarRGBAccent.BackgroundColor3 = colour
		if Main:FindFirstChild('Search') and Main.Search:FindFirstChild('UIStroke') then
			Main.Search.UIStroke.Color = colour
		end
		if KeySystemRGBStroke and KeySystemRGBStroke.Parent then
			KeySystemRGBStroke.Color = colour
			KeySystemRGBStroke.Transparency = 0
		end
	end)
end

local function stopRGBSync()
	if RGBSyncConnection then
		RGBSyncConnection:Disconnect()
		RGBSyncConnection = nil
	end
	MainRGBStroke.Transparency = 1
	TopbarRGBAccent.BackgroundTransparency = 1
	if Main:FindFirstChild('Search') and Main.Search:FindFirstChild('UIStroke') then
	...
	if KeySystemRGBStroke and KeySystemRGBStroke.Parent then
		KeySystemRGBStroke.Transparency = 0.4
	end
end

-- Toggle the rainbow effect on or off at any time. Speed is optional (default 1).
function RayfieldLibrary:SetRGBSync(enabled: boolean, speed: number?)
	RGBSyncEnabled = enabled and true or false
	if speed then RGBSyncSpeed = speed end
	if RGBSyncEnabled then
		startRGBSync()
	else
		stopRGBSync()
	end
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.RGBSync then
		RayfieldLibrary:SetRGBSync(true, Settings.RGBSyncSpeed)
	end
	...
	if (Settings.KeySystem) then
		...
		if not Passthrough then
			...
			-- Visual design pass: make the Key System screen match the active
			-- theme instead of always showing its hardcoded default look
			KeyMain.BackgroundColor3 = SelectedTheme.Background
			KeyMain.Title.TextColor3 = SelectedTheme.TextColor
			KeyMain.Subtitle.TextColor3 = SelectedTheme.TextColor
			KeyMain.KeyNote.TextColor3 = SelectedTheme.TextColor
			KeyMain.NoteTitle.TextColor3 = SelectedTheme.TextColor
			KeyMain.NoteMessage.TextColor3 = SelectedTheme.TextColor
			KeyMain.Shadow.Image.ImageColor3 = SelectedTheme.Shadow
			KeyMain.Hide.ImageColor3 = SelectedTheme.TextColor
			KeyMain.Input.BackgroundColor3 = SelectedTheme.InputBackground
			KeyMain.Input.UIStroke.Color = SelectedTheme.InputStroke
			...
			-- Subtle themed border around the whole Key System card
			local KeyBorder = KeyMain:FindFirstChild("RGBStroke")
			if not KeyBorder then
				KeyBorder = Instance.new("UIStroke")
				KeyBorder.Name = "RGBStroke"
				KeyBorder.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
				KeyBorder.Thickness = 1.5
				KeyBorder.Parent = KeyMain
			end
			KeyBorder.Color = SelectedTheme.ElementStroke
			KeyBorder.Transparency = RGBSyncEnabled and 0 or 0.4
			KeySystemRGBStroke = KeyBorder

			-- Gradient accent bar across the top of the card for a more
			-- polished, premium look
			local KeyAccent = KeyMain:FindFirstChild("TopAccent")
			if not KeyAccent then
				KeyAccent = Instance.new("Frame")
				KeyAccent.Name = "TopAccent"
				KeyAccent.BorderSizePixel = 0
				KeyAccent.Size = UDim2.new(1, 0, 0, 3)
				KeyAccent.Position = UDim2.new(0, 0, 0, 0)
				KeyAccent.ZIndex = 5
				KeyAccent.Parent = KeyMain
			end
			KeyAccent.BackgroundColor3 = SelectedTheme.SliderProgress
			local KeyAccentGradient = KeyAccent:FindFirstChildOfClass("UIGradient")
			if not KeyAccentGradient then
				KeyAccentGradient = Instance.new("UIGradient")
				KeyAccentGradient.Parent = KeyAccent
			end
			KeyAccentGradient.Color = ColorSequence.new(SelectedTheme.SliderProgress, SelectedTheme.ToggleEnabled)
...
if useStudio then
	...
	--	Theme = 'Default', -- Try 'Nebula' for the new theme
	--	Icon = 0,
	--	LoadingSubtitle = "by Sirius",
	--	RGBSync = false, -- Set this to true for an animated rainbow border/accent effect
	--	RGBSyncSpeed = 1, -- Optional, higher = faster colour cycling
	--	ConfigurationSaving = {
	--		Enabled = true,
